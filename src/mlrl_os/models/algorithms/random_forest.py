"""Random Forest algorithm wrapper for ML/RL OS."""
...
class RandomForestAlgorithm:
    ...
    Supports both regression (RandomForestRegressor) and classification
    (RandomForestClassifier). Sklearn is a required dependency so no
    lazy import guard is needed, but we import inside train() to stay
    consistent with the other algorithm wrappers.
    """
    ...
    def train(
        ...
        **kwargs: Any,
        ...
        Returns:
            TrainedModel wrapping the fitted RandomForest estimator.
